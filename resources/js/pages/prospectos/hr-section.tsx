        ...
        <div className="space-y-4">
                    ...
                    <TableBody>
                        {records.length === 0 ? (
                            <TableRow>
                                ...
                                >
                                    No hay registros. Haga clic en "Agregar"
                                    para añadir uno.
                                </TableCell>
                            </TableRow>
                        ) : (
            ...
            <Dialog open={openModal} onOpenChange={setOpenModal}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>
                            Captura de Número de Empleados
                        </DialogTitle>
                        <DialogDescription>
