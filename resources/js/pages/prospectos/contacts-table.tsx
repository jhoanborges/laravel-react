...
export function ContactsTable() {
  const { contacts, addContact, updateContact, deleteContact } = useContactsTable()
          ...
          <tbody>
            {contacts.map((contact) => (
              <tr key={contact.id} className="border-b hover:bg-muted/50">
                <td className="px-4 py-2 text-muted-foreground">{contact.numero}</td>
                <td className="px-4 py-2">
                  <Input
                    value={contact.contacto}
                    onChange={(e) =>
                      updateContact(contact.id, 'contacto', e.target.value)
                    }
                    placeholder="Nombre"
                    className="h-8"
                  />
                ...
                <td className="px-4 py-2">
                  <Input
                    ...
                    onChange={(e) =>
                      updateContact(contact.id, 'puesto', e.target.value)
                    }
                    placeholder="Puesto"
                    className="h-8"
                  />
                ...
                <td className="px-4 py-2">
                  <Input
                    ...
                    onChange={(e) =>
                      updateContact(contact.id, 'telefono', e.target.value)
                    }
                ...
                <td className="px-4 py-2">
                  <Input
                    value={contact.tipo}
                    onChange={(e) =>
                      updateContact(contact.id, 'tipo', e.target.value)
                    }
                    placeholder="Tipo"
                    className="h-8"
                  />
                ...
                <td className="px-4 py-2">
                  <Input
                    ...
                    onChange={(e) =>
                      updateContact(contact.id, 'correoElectronico', e.target.value)
                    }
