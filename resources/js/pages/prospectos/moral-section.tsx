...
export function MoralSection() {
    ...
    return (
        <div className="space-y-4 rounded-lg bg-secondary/10 p-4">
            <h3 className="border-b pb-2 font-semibold text-primary">Moral</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ socialReason: e.target.value })
                        }
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ societyType: e.target.value })
                        }
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ registrationNumber: e.target.value })
                        }
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ registrationDate: e.target.value })
                        }
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ registrationPlaza: e.target.value })
                        }
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ notaryName: e.target.value })
                        }
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Select
                        value={moral.nationality}
                        onValueChange={(value) =>
                            updateMoral({ nationality: value })
                        }
                    >
                        <SelectTrigger>
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ rfcInscription: e.target.value })
                        }
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ rfcInscriptionDate: e.target.value })
                        }
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ rfcInscriptionPlaza: e.target.value })
                        }
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ notaryNumber: e.target.value })
                        }
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ constitutionDate: e.target.value })
                        }
                    />
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <Input
                        ...
                        onChange={(e) =>
                            updateMoral({ socialReasonFiscal: e.target.value })
                        }
